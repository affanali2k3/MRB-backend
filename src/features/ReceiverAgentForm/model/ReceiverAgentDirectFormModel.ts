...
export class ReceiverAgentDirectForm extends Model {
    ...
    public static RECEIVER_AGENT = 'receiver_agent_direct_form_receiver_agent' as string
    // The sender form this receiver form is linked to
    public static SENDER_AGENT_DIRECT_FORM_ID = 'sender_agent_direct_form_id' as string
    ...
    @Column({
        ...
        references: { model: SenderAgentDirectForm.TABLE_NAME, key: SenderAgentDirectForm.ID },
        allowNull: false
    })
