...
export class AgentInvitee extends Model {
    ...
    public static INVITER_USER_EMAIL = "agent_invitee_inviter_user_email" as string; // Define the column name constant for the ID field
    public static INVITEE_USER_EMAIL = "agent_invitee_invitee_user_email" as string; // Define the column name constant for the POST_ID field
