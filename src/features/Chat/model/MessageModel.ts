...
export class Message extends Model {
    ...
    public static SENDER_ID = 'sender_id' as string; // Define the column name for the sender's email
    public static RECEIVER_ID = 'receiver_id' as string; // Define the column name for the receiver's email
