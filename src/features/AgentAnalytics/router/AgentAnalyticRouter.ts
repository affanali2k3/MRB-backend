...
class AgentAnalyticRouter extends BaseRoutes {
  routes(): void {
    ...
    this.router.patch(
      "/update/referrals-received",
      AgentAnalyticController.updateReferralsReceived
    );
    this.router.get(
      "/get-agent-analytic",
      AgentAnalyticController.getAgentAnalytic
    );
    this.router.patch(
      "/update/referrals-sent",
      AgentAnalyticController.updateReferralsSent
    );
    this.router.patch(
      "/update/agent-to-agent-rating",
      AgentAnalyticController.updateAgentToAgentRating
    );
    this.router.patch(
      "/update/client-to-agent-rating",
      AgentAnalyticController.updateClientToAgentRating
    );
  }
}
